...
export class Gen1724891244388 implements MigrationInterface {
  name = 'Gen1724891244388';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "survey" ("surveyId" character varying NOT NULL, "title" character varying NOT NULL, "targetAudience" character varying NOT NULL, "starRating" integer NOT NULL, "contactEmail" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2bb1a75a612fa166da6f77122ba" PRIMARY KEY ("surveyId"))`,
    );
    await queryRunner.query(
